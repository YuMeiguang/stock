...
auth = oss2.Auth(constant.accessKeyId,constant.ccessKeySecret)
# Endpoint以杭州为例，其它Region请按实际情况填写。
bucket = oss2.Bucket(auth, 'http://oss-cn-beijing.aliyuncs.com', constant.bucketName)
...
result = bucket.put_object_from_file('aa', 'aa.py')
